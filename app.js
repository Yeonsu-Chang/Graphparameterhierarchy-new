(function () {
  ...
  const nodes = Array.from(labelsInNormal).map((label) => {
    ...
    return { data: { id: toId(label), label: display } };
  });
  ...
  const cy = cytoscape({
    ...
    style: [
      ...
      { selector: "node.NH_OUT", style: { "border-color": "#5c73c4", "border-width": 4, "background-color": "#e4e9fb" } },
      { selector: "node.NH_IN", style: { "border-color": "#3c8d78", "border-width": 4, "background-color": "#dff1ec" } },
      { selector: "node.dim", style: { opacity: 0.1 } },
      { selector: "node.hidden", style: { display: "none" } },
      { selector: "node.SEL", style: { "border-color": "#c94f65", "background-color": "#ffe8ec", "border-width": 5, "z-index": 10 } },
      { selector: "node.path-node", style: { "border-color": "#ad762f", "background-color": "#fff1da", "border-width": 5, opacity: 1 } },
      { selector: "node.path-start", style: { "border-color": "#536fc5", "background-color": "#e8edff", "border-width": 6, opacity: 1 } },
      { selector: "node.path-end", style: { "border-color": "#c94f65", "background-color": "#ffe8ec", "border-width": 6, opacity: 1 } },
